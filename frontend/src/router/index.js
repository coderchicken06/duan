...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/admin/marketing', name: 'admin-marketing', meta: { admin: true }, component: () => import('../views/admin/AdminMarketing.vue') },
    { path: '/admin/contracts', name: 'admin-contracts', meta: { admin: true }, component: () => import('../views/admin/AdminContracts.vue') },
