        ...
        <tbody>
          ...
          <tr v-for="car in cars" v-else :key="car.id">
            ...
            <td class="text-end action-cell">
              ...
              <button class="btn btn-sm cs-btn-danger" type="button" @click="remove(car)">Xóa</button>
            </td>
          </tr>
