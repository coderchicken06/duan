    ...
    <div class="container cs-container">
      <div class="row justify-content-center">
        <div class="col-12 col-md-7 col-lg-5">
              ...
              <form class="vstack gap-3" @submit.prevent="submit">
                ...
                <div>
                  ...
                  <div class="input-group"><input v-model="password" :type="showPassword ? 'text' : 'password'"
                      ...
                      autocomplete="current-password" /><button class="btn password-toggle" type="button"
                ...
                <button class="btn cs-btn cs-btn-primary w-100" type="submit" :disabled="loading"><span v-if="loading"
                    class="spinner-border spinner-border-sm me-2"></span>{{ loading ? 'Đang đăng nhập...' : 'Đăng nhập'
                  }}</button>
          ...
          <p class="auth-footer text-center mt-3 mb-0">CarStore · Đồng hành cùng mọi hành trình</p>
        </div>
      </div>
    </div>
  </div>
