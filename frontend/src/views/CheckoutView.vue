<template>
  <div class="container cs-container py-5">
    <div class="cs-card checkout-card overflow-hidden">
      <div class="checkout-header p-4"><span class="checkout-step">XÁC NHẬN ĐƠN</span>
        <h2 class="cs-page-title mt-2 mb-1">Gửi yêu cầu đặt xe</h2>
        <p class="text-secondary mb-0">Kiểm tra thông tin trước khi gửi yêu cầu đến CarStore.</p>
      </div>
      <div class="p-4">
        <form class="vstack gap-3" @submit.prevent="submit">
          <div>
            <label class="form-label cs-muted">Địa chỉ giao hàng</label>
            <textarea v-model="address" class="form-control" rows="3" required
              placeholder="Nhập địa chỉ nhận xe"></textarea>
          </div>
          <div>
