      ...
      <section class="support-layout">
        <aside class="support-info">
          <article class="support-info-item">
            ...
            <div>
              <h2>Tư vấn mua xe</h2>
              <p>Giải đáp thông tin sản phẩm và lựa chọn xe phù hợp.</p>
            </div>
          </article>
          <article class="support-info-item">
            <span>02</span>
            <div>
              <h2>Bảo hành</h2>
              <p>Tiếp nhận yêu cầu kiểm tra bảo hành hoặc phản hồi dịch vụ.</p>
            </div>
          </article>
          <article class="support-info-item">
            <span>03</span>
            <div>
              <h2>Yêu cầu chung</h2>
              <p>Gửi câu hỏi khác liên quan đến sản phẩm và tài khoản.</p>
            </div>
          </article>
        ...
        <div class="cs-card support-form-card">
          ...
          <form class="support-form" novalidate @submit.prevent="submit">
            <div class="field">
              ...
              <input id="support-name" v-model.trim="form.name" class="form-control" maxlength="255"
                autocomplete="name" />
            </div>
            <div class="field">
            ...
            <div class="field">
              ...
              <input id="support-car" v-model.trim="form.carInfo" class="form-control" maxlength="255"
            ...
            <div class="field field-full">
              ...
              <textarea id="support-content" v-model.trim="form.content" class="form-control" rows="5" maxlength="1000"
...
.support-heading .ford-hero-panel-content {
  max-width: 760px
}
