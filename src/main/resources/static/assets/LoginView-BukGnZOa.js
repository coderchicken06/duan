...
import { a as useRoute, c as vModelDynamic, f as withModifiers, i as useAuthStore, n as _plugin_vue_export_helper_default, o as useRouter, u as vModelText } from "./index-DOyj8jjE.js";
	...
	setup(__props) {
		...
		async function submit() {
			...
			try {
				...
				if (data.success) router.push(String(route.query.redirect || "/"));
