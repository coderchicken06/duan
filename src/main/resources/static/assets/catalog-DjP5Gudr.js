import { D as createCommentVNode, Dt as toDisplayString, G as watch, K as withCtx, M as createVNode, O as createElementBlock, T as createBaseVNode, Tt as normalizeClass, V as openBlock, W as resolveComponent, a as carImageUrl, c as formatPrice, i as carApi, j as createTextVNode, ot as unref, p as promotionApi, r as brandApi, tt as ref, v as useDefaultCarImage, w as computed } from "./api-BIOmrm3q.js";
import { n as useAuthStore, r as useCompare, s as defineStore, t as _plugin_vue_export_helper_default } from "./index-B5QpE601.js";
...
var _hoisted_12 = { class: "current-price" };
var _hoisted_13 = ["title"];
var _hoisted_14 = {
	key: 3,
	class: "price-slot promotion-slot",
	"aria-hidden": "true"
};
var _hoisted_15 = { class: "compare-check" };
var _hoisted_16 = ["checked"];
var _hoisted_17 = { class: "ford-car-actions" };
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("article", _hoisted_1, [createBaseVNode("div", _hoisted_2, [createBaseVNode("img", {
				...
				createBaseVNode("div", { class: normalizeClass(["car-price-block", { "has-promotion": promotion.value }]) }, [
					promotion.value ? (openBlock(), createElementBlock("span", _hoisted_10, toDisplayString(unref(formatPrice)(__props.car.price)) + " VNĐ", 1)) : (openBlock(), createElementBlock("span", _hoisted_11)),
					createBaseVNode("strong", _hoisted_12, [createTextVNode(toDisplayString(unref(formatPrice)(promotion.value ? discountedPrice.value : __props.car.price)) + " ", 1), _cache[2] || (_cache[2] = createBaseVNode("small", null, "VNĐ", -1))]),
					promotion.value ? (openBlock(), createElementBlock("span", {
						key: 2,
						class: "promotion-badge",
						title: `${promotionTitle.value} - ${promotionLabel.value}`
					}, toDisplayString(promotionTitle.value) + " - " + toDisplayString(promotionLabel.value), 9, _hoisted_13)) : (openBlock(), createElementBlock("span", _hoisted_14))
				], 2),
				createBaseVNode("label", _hoisted_15, [createBaseVNode("input", {
					type: "checkbox",
					checked: unref(has)(__props.car.id),
					onChange: onCompare
				}, null, 40, _hoisted_16), _cache[3] || (_cache[3] = createTextVNode(" So sánh xe", -1))]),
				createBaseVNode("div", _hoisted_17, [createVNode(_component_router_link, {
				...
				}, toDisplayString(stock.value > 0 ? "Đặt cọc ngay" : "Hết hàng"), 9, _hoisted_18)) : createCommentVNode("", true)])
			])]);
		};
	}
}, [["__scopeId", "data-v-8cee6305"]]);
//#endregion
