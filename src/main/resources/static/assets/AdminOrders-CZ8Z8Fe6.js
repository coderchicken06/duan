import { D as createCommentVNode, Dt as toDisplayString, G as watch, O as createElementBlock, S as Fragment, T as createBaseVNode, U as renderList, V as openBlock, a as carImageUrl, ot as unref, t as adminApi, tt as ref, v as useDefaultCarImage, z as onMounted } from "./api-BIOmrm3q.js";
import { a as useRoute, t as _plugin_vue_export_helper_default } from "./index-B5QpE601.js";
...
var AdminOrders_default = /*#__PURE__*/ _plugin_vue_export_helper_default({
	...
	setup(__props) {
		...
		function availableStatuses(order) {
			...
			if (order.status === "CONFIRMED") return order.depositStatus === "PAID" ? ["CONFIRMED", "PROCESSING"] : ["CONFIRMED"];
			...
			return openBlock(), createElementBlock("div", _hoisted_1, [
				...
				createBaseVNode("div", _hoisted_2, [createBaseVNode("table", _hoisted_3, [_cache[2] || (_cache[2] = createBaseVNode("thead", null, [createBaseVNode("tr", null, [
					...
					return openBlock(), createElementBlock("tr", { key: o.id }, [
						...
						createBaseVNode("td", null, [canCancel(o) ? (openBlock(), createElementBlock("button", {
							key: 0,
