import { A as createStaticVNode, D as createCommentVNode, Dt as toDisplayString, K as withCtx, M as createVNode, O as createElementBlock, S as Fragment, T as createBaseVNode, Tt as normalizeClass, U as renderList, V as openBlock, W as resolveComponent, a as carImageUrl, c as formatPrice, j as createTextVNode, ot as unref, tt as ref, v as useDefaultCarImage, w as computed, y as api, z as onMounted } from "./api-Cd2rmWmR.js";
...
var _hoisted_20 = { class: "contract-actions" };
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("main", _hoisted_1, [loading.value ? (openBlock(), createElementBlock("div", _hoisted_2, [..._cache[2] || (_cache[2] = [createBaseVNode("span", { class: "spinner-border text-danger" }, null, -1), createBaseVNode("p", { class: "mt-3" }, "Đang tải hợp đồng...", -1)])])) : error.value ? (openBlock(), createElementBlock("div", _hoisted_3, [createBaseVNode("div", _hoisted_4, toDisplayString(error.value), 1)])) : (openBlock(), createElementBlock("article", _hoisted_5, [
				...
				_cache[27] || (_cache[27] = createStaticVNode("<section class=\"contract-section terms\" data-v-4e0dff3d><h2 data-v-4e0dff3d>Điều khoản</h2><ol data-v-4e0dff3d><li data-v-4e0dff3d>Xe được bàn giao theo đúng thông tin và tình trạng hai bên đã xác nhận.</li><li data-v-4e0dff3d>Chính sách bảo hành áp dụng theo thông tin công bố của showroom và nhà sản xuất.</li><li data-v-4e0dff3d>Thời gian giao xe được thống nhất sau khi hoàn tất nghĩa vụ thanh toán.</li><li data-v-4e0dff3d>Việc hoàn tiền cọc thực hiện theo trạng thái đơn và thỏa thuận được hai bên xác nhận.</li></ol></section><section class=\"signatures\" data-v-4e0dff3d><div data-v-4e0dff3d>KHÁCH HÀNG<small data-v-4e0dff3d>(Ký và ghi rõ họ tên)</small></div><div data-v-4e0dff3d>NHÂN VIÊN<small data-v-4e0dff3d>(Ký và ghi rõ họ tên)</small></div><div data-v-4e0dff3d>ĐẠI DIỆN SHOWROOM<small data-v-4e0dff3d>(Ký, đóng dấu)</small></div></section>", 2)),
