import { A as createStaticVNode, D as createCommentVNode, Dt as toDisplayString, O as createElementBlock, T as createBaseVNode, Tt as normalizeClass, V as openBlock, g as supportApi, j as createTextVNode, ot as unref, q as withDirectives, tt as ref } from "./api-Cd2rmWmR.js";
import { d as vModelText, i as useAuthStore, n as _plugin_vue_export_helper_default, p as withModifiers, u as vModelSelect } from "./index-BX99C7pg.js";
...
var SupportView_default = /*#__PURE__*/ _plugin_vue_export_helper_default({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			...
			])], -1)), createBaseVNode("div", _hoisted_2, [createBaseVNode("section", _hoisted_3, [_cache[13] || (_cache[13] = createStaticVNode("<aside class=\"support-info\" data-v-2dd1381f><article class=\"support-info-item\" data-v-2dd1381f><span data-v-2dd1381f>01</span><div data-v-2dd1381f><h2 data-v-2dd1381f>Tư vấn mua xe</h2><p data-v-2dd1381f>Giải đáp thông tin sản phẩm và lựa chọn xe phù hợp.</p></div></article><article class=\"support-info-item\" data-v-2dd1381f><span data-v-2dd1381f>02</span><div data-v-2dd1381f><h2 data-v-2dd1381f>Bảo hành</h2><p data-v-2dd1381f>Tiếp nhận yêu cầu kiểm tra bảo hành hoặc phản hồi dịch vụ.</p></div></article><article class=\"support-info-item\" data-v-2dd1381f><span data-v-2dd1381f>03</span><div data-v-2dd1381f><h2 data-v-2dd1381f>Yêu cầu chung</h2><p data-v-2dd1381f>Gửi câu hỏi khác liên quan đến sản phẩm và tài khoản.</p></div></article><div class=\"support-contact\" data-v-2dd1381f><strong data-v-2dd1381f>Cần hỗ trợ?</strong><span data-v-2dd1381f>Hotline: 1900 9999</span><span data-v-2dd1381f>Email: support@carstore.vn</span></div></aside>", 1)), createBaseVNode("div", _hoisted_4, [_cache[12] || (_cache[12] = createBaseVNode("div", { class: "form-heading" }, [createBaseVNode("h2", null, "Gửi yêu cầu hỗ trợ"), createBaseVNode("p", null, [
