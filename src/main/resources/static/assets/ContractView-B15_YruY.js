	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("main", _hoisted_1, [loading.value ? (openBlock(), createElementBlock("div", _hoisted_2, [..._cache[2] || (_cache[2] = [createBaseVNode("span", { class: "spinner-border text-danger" }, null, -1), createBaseVNode("p", { class: "mt-3" }, "Đang tải hợp đồng...", -1)])])) : error.value ? (openBlock(), createElementBlock("div", _hoisted_3, [createBaseVNode("div", _hoisted_4, toDisplayString(error.value), 1)])) : (openBlock(), createElementBlock("article", _hoisted_5, [
				...
				_cache[27] || (_cache[27] = createStaticVNode("<section class=\"contract-section terms\" data-v-b776c17e><h2 data-v-b776c17e>Điều khoản</h2><ol data-v-b776c17e><li data-v-b776c17e>Xe được bàn giao theo đúng thông tin và tình trạng hai bên đã xác nhận.</li><li data-v-b776c17e>Chính sách bảo hành áp dụng theo thông tin công bố của showroom và nhà sản xuất.</li><li data-v-b776c17e>Thời gian giao xe được thống nhất sau khi hoàn tất nghĩa vụ thanh toán.</li><li data-v-b776c17e>Việc hoàn tiền cọc thực hiện theo trạng thái đơn và thỏa thuận được hai bên xác nhận.</li></ol></section><section class=\"signatures\" data-v-b776c17e><div data-v-b776c17e>KHÁCH HÀNG<small data-v-b776c17e>(Ký và ghi rõ họ tên)</small></div><div data-v-b776c17e>NHÂN VIÊN<small data-v-b776c17e>(Ký và ghi rõ họ tên)</small></div><div data-v-b776c17e>ĐẠI DIỆN SHOWROOM<small data-v-b776c17e>(Ký, đóng dấu)</small></div></section>", 2)),
