import { D as createCommentVNode, Dt as toDisplayString, G as watch, K as withCtx, M as createVNode, O as createElementBlock, S as Fragment, T as createBaseVNode, U as renderList, V as openBlock, W as resolveComponent, j as createTextVNode, o as cartApi, q as withDirectives, tt as ref, w as computed, z as onMounted } from "./api-BIOmrm3q.js";
import { a as useRoute, i as useCartStore, t as _plugin_vue_export_helper_default, u as vModelSelect } from "./index-B5QpE601.js";
...
var CarListView_default = /*#__PURE__*/ _plugin_vue_export_helper_default({
	...
	setup(__props) {
		...
		async function loadCars(silent = false, force = false) {
			...
			try {
				const [carData, brandData] = await Promise.all([catalog.loadCars(force), catalog.loadBrands(force)]);
