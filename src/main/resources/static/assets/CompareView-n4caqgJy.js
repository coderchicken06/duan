import { Dt as toDisplayString, K as withCtx, M as createVNode, O as createElementBlock, S as Fragment, T as createBaseVNode, Tt as normalizeClass, U as renderList, V as openBlock, W as resolveComponent, a as carImageUrl, c as formatPrice, i as carApi, j as createTextVNode, ot as unref, tt as ref, v as useDefaultCarImage, w as computed, z as onMounted } from "./api-Cd2rmWmR.js";
import { a as useRoute, n as _plugin_vue_export_helper_default, o as useRouter, t as useCompare } from "./index-DOyj8jjE.js";
...
var _hoisted_7 = { class: "price" };
var _hoisted_8 = { class: "label-col" };
var CompareView_default = /*#__PURE__*/ _plugin_vue_export_helper_default({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("main", _hoisted_1, [createBaseVNode("div", { class: "compare-heading" }, [_cache[1] || (_cache[1] = createBaseVNode("div", null, [
			...
			}, "Xóa lựa chọn")]), loading.value ? (openBlock(), createElementBlock("div", _hoisted_2, "Đang tải...")) : cars.value.length < 2 ? (openBlock(), createElementBlock("div", _hoisted_3, "Bạn cần chọn ít nhất 2 xe để so sánh.")) : (openBlock(), createElementBlock("div", _hoisted_4, [createBaseVNode("table", _hoisted_5, [createBaseVNode("thead", null, [createBaseVNode("tr", null, [_cache[3] || (_cache[3] = createBaseVNode("th", { class: "label-col" }, "Tiêu chí", -1)), (openBlock(true), createElementBlock(Fragment, null, renderList(cars.value, (car) => {
				return openBlock(), createElementBlock("th", { key: car.id }, [
					createBaseVNode("img", {
						src: unref(carImageUrl)(car.image),
						alt: car.name,
						onError: _cache[0] || (_cache[0] = (...args) => unref(useDefaultCarImage) && unref(useDefaultCarImage)(...args))
					}, null, 40, _hoisted_6),
					createBaseVNode("h3", null, toDisplayString(car.name), 1),
					createBaseVNode("div", _hoisted_7, toDisplayString(unref(formatPrice)(car.price)) + " VNĐ", 1),
					createVNode(_component_router_link, { to: `/car/detail/${car.id}` }, {
						default: withCtx(() => [..._cache[2] || (_cache[2] = [createTextVNode("Xem chi tiết", -1)])]),
						_: 1
					}, 8, ["to"])
				]);
			}), 128))])]), createBaseVNode("tbody", null, [(openBlock(true), createElementBlock(Fragment, null, renderList(rows.value, (row) => {
				return openBlock(), createElementBlock("tr", { key: row.label }, [createBaseVNode("td", _hoisted_8, toDisplayString(row.label), 1), (openBlock(true), createElementBlock(Fragment, null, renderList(row.values, (value, index) => {
