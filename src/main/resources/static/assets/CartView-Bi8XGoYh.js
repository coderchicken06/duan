...
import { n as _plugin_vue_export_helper_default, r as useCartStore } from "./index-BCOVk736.js";
...
var _hoisted_17 = { class: "cart-line-total" };
var _hoisted_18 = { class: "cs-card cart-summary" };
var _hoisted_19 = { class: "summary-row" };
var _hoisted_20 = { class: "summary-total" };
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("main", _hoisted_1, [_cache[13] || (_cache[13] = createBaseVNode("header", { class: "ford-hero-panel compact content-only cart-heading" }, [createBaseVNode("div", { class: "ford-hero-panel-content" }, [
				...
				return openBlock(), createElementBlock("article", {
					...
					_cache[7] || (_cache[7] = createBaseVNode("div", { class: "cart-quantity" }, [createBaseVNode("span", { class: "cart-label" }, "Số lượng"), createBaseVNode("strong", null, "1 xe")], -1)),
					createBaseVNode("div", _hoisted_17, [_cache[6] || (_cache[6] = createBaseVNode("span", { class: "cart-label" }, "Thành tiền", -1)), createBaseVNode("strong", null, toDisplayString(unref(formatPrice)(item.price * item.quantity)) + " VNĐ", 1)])
				])])]);
			}), 128))]), createBaseVNode("aside", _hoisted_18, [
				_cache[12] || (_cache[12] = createBaseVNode("h2", null, "Tóm tắt phiếu đặt cọc", -1)),
				createBaseVNode("div", _hoisted_19, [_cache[8] || (_cache[8] = createBaseVNode("span", null, "Số lượng", -1)), createBaseVNode("strong", null, toDisplayString(totalQuantity.value) + " xe", 1)]),
				createBaseVNode("div", _hoisted_20, [_cache[9] || (_cache[9] = createBaseVNode("span", null, "Tổng tiền", -1)), createBaseVNode("strong", null, toDisplayString(unref(formatPrice)(total.value)) + " VNĐ", 1)]),
				createVNode(_component_router_link, {
					class: "btn cs-btn cs-btn-primary w-100",
					to: "/checkout"
				}, {
					default: withCtx(() => [..._cache[10] || (_cache[10] = [createTextVNode("Tiến hành đặt cọc", -1)])]),
					_: 1
				}),
				createBaseVNode("button", {
					...
					onClick: clearCart
				}, toDisplayString(clearing.value ? "Đang xóa..." : "Xóa toàn bộ xe đã chọn"), 9, _hoisted_21),
				createVNode(_component_router_link, {
					class: "cart-continue",
					to: "/car/list"
				}, {
			...
			])])), message.value ? (openBlock(), createElementBlock("div", _hoisted_22, toDisplayString(message.value), 1)) : createCommentVNode("", true)])]);
		};
	}
}, [["__scopeId", "data-v-e4ac08ea"]]);
//#endregion
