import { D as createCommentVNode, Dt as toDisplayString, O as createElementBlock, T as createBaseVNode, V as openBlock, c as formatPrice, j as createTextVNode, m as quotationApi, o as cartApi, ot as unref, q as withDirectives, tt as ref, u as orderApi, z as onMounted } from "./api-BIOmrm3q.js";
import { d as vModelText, i as useCartStore, n as useAuthStore, o as useRouter, p as withModifiers, t as _plugin_vue_export_helper_default } from "./index-B5QpE601.js";
...
var CheckoutView_default = /*#__PURE__*/ _plugin_vue_export_helper_default({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1, [createBaseVNode("div", _hoisted_2, [_cache[5] || (_cache[5] = createBaseVNode("div", { class: "checkout-header p-4" }, [
				...
				_cache[4] || (_cache[4] = createBaseVNode("p", { class: "checkout-hold-note" }, "Thời gian giữ chỗ thanh toán cọc: 03 phút (Quá hạn hệ thống tự động hoàn xe về kho)", -1)),
