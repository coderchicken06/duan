import { D as createCommentVNode, Dt as toDisplayString, G as watch, M as createVNode, O as createElementBlock, R as onBeforeUnmount, S as Fragment, T as createBaseVNode, Tt as normalizeClass, U as renderList, V as openBlock, g as supportApi, i as carApi, j as createTextVNode, ot as unref, q as withDirectives, tt as ref, w as computed, z as onMounted } from "./api-BIOmrm3q.js";
import { a as useRoute, d as vModelText, n as useAuthStore, p as withModifiers, t as _plugin_vue_export_helper_default, u as vModelSelect } from "./index-B5QpE601.js";
import { t as notifyDataUpdated } from "./useAutoRefresh-B7w7pWdx.js";
import { t as DatePickerInput_default } from "./DatePickerInput-BCHZA4eB.js";
...
var ServiceView_default = /*#__PURE__*/ _plugin_vue_export_helper_default({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("main", _hoisted_1, [_cache[15] || (_cache[15] = createBaseVNode("section", { class: "ford-hero-panel compact content-only service-hero" }, [createBaseVNode("div", { class: "ford-hero-panel-content" }, [
			...
			}), 64))]), createBaseVNode("section", _hoisted_5, [_cache[14] || (_cache[14] = createBaseVNode("div", { class: "booking-intro" }, [
				...
				createBaseVNode("div", _hoisted_6, [_cache[7] || (_cache[7] = createBaseVNode("label", { for: "service-name" }, "Họ tên *", -1)), withDirectives(createBaseVNode("input", {
					id: "service-name",
				...
				createBaseVNode("div", _hoisted_7, [_cache[8] || (_cache[8] = createBaseVNode("label", { for: "service-phone" }, "Số điện thoại *", -1)), withDirectives(createBaseVNode("input", {
					id: "service-phone",
				...
				createBaseVNode("div", _hoisted_8, [
					_cache[9] || (_cache[9] = createBaseVNode("label", { for: "service-car" }, "Thông tin xe / biển số *", -1)),
				...
				createBaseVNode("div", _hoisted_10, [_cache[11] || (_cache[11] = createBaseVNode("label", { for: "service-type" }, "Loại dịch vụ *", -1)), withDirectives(createBaseVNode("select", {
					id: "service-type",
					"onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => form.value.serviceType = $event),
					class: "form-select"
				}, [..._cache[10] || (_cache[10] = [
				...
				createBaseVNode("div", _hoisted_11, [_cache[12] || (_cache[12] = createBaseVNode("label", { for: "service-date" }, "Ngày hẹn *", -1)), createVNode(DatePickerInput_default, {
					id: "service-date",
					modelValue: form.value.appointmentDate,
					"onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => form.value.appointmentDate = $event),
					min: minimumAppointmentDate.value,
					"aria-label": "Ngày hẹn",
					title: "Ngày hẹn (dd/mm/yyyy)"
				}, null, 8, ["modelValue", "min"])]),
				createBaseVNode("div", _hoisted_12, [
					_cache[13] || (_cache[13] = createBaseVNode("label", { for: "service-time" }, "Giờ hẹn *", -1)),
					withDirectives(createBaseVNode("input", {
						id: "service-time",
						"onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => form.value.appointmentTime = $event),
