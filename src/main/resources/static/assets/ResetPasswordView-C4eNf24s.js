...
import { c as vModelDynamic, f as withModifiers, n as _plugin_vue_export_helper_default, o as useRouter } from "./index-DOyj8jjE.js";
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1, [createBaseVNode("div", _hoisted_2, [createBaseVNode("div", _hoisted_3, [createBaseVNode("div", _hoisted_4, [
				...
				createBaseVNode("form", {
					...
					createBaseVNode("div", null, [_cache[3] || (_cache[3] = createBaseVNode("label", { class: "form-label" }, "Mật khẩu mới", -1)), createBaseVNode("div", _hoisted_6, [withDirectives(createBaseVNode("input", {
					...
					createBaseVNode("div", null, [_cache[4] || (_cache[4] = createBaseVNode("label", { class: "form-label" }, "Xác nhận mật khẩu", -1)), withDirectives(createBaseVNode("input", {
						...
						autocomplete: "new-password"
					}, null, 8, _hoisted_8), [[vModelDynamic, confirmPassword.value]])]),
