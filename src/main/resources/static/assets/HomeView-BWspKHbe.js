import { D as createCommentVNode, Dt as toDisplayString, G as watch, K as withCtx, M as createVNode, O as createElementBlock, S as Fragment, T as createBaseVNode, U as renderList, V as openBlock, W as resolveComponent, i as carApi, j as createTextVNode, o as cartApi, tt as ref, z as onMounted } from "./api-Cd2rmWmR.js";
import { a as useRoute, n as _plugin_vue_export_helper_default, r as useCartStore } from "./index-DOyj8jjE.js";
...
var HomeView_default = /*#__PURE__*/ _plugin_vue_export_helper_default({
	...
	setup(__props) {
		...
		async function loadCars(silent = false) {
			...
			try {
				const { data } = await carApi.getAll(String(q.value || "") || void 0);
		...
		async function addToCart(id) {
			...
			if (data.success) {
				...
				alert.value = "";
			} else alert.value = data.message || "Không thể thêm vào giỏ";
		}
		return (_ctx, _cache) => {
