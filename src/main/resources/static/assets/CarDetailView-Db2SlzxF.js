			...
			return car.value ? (openBlock(), createElementBlock("main", _hoisted_1, [createBaseVNode("div", _hoisted_2, [
				createBaseVNode("div", _hoisted_3, [createBaseVNode("section", _hoisted_4, [createBaseVNode("div", _hoisted_5, [
					...
					createBaseVNode("div", _hoisted_17, [
						!unref(auth).isAdmin ? (openBlock(), createElementBlock("button", {
							key: 0,
							...
							class: "action-icon",
							"aria-hidden": "true"
						}, "🛒", -1)), createBaseVNode("span", null, toDisplayString(addingToCart.value ? "Đang chuẩn bị..." : Number(car.value.stock || 0) > 0 ? "Đặt cọc giữ chỗ" : "Xe đã hết hàng"), 1)], 8, _hoisted_18)) : createCommentVNode("", true),
						...
						!unref(auth).isAdmin ? (openBlock(), createElementBlock("button", {
							...
							class: "action-icon",
							"aria-hidden": "true"
						}, "₫", -1), createBaseVNode("span", null, "Yêu cầu báo giá", -1)])])) : createCommentVNode("", true)
					]),
