import { D as createCommentVNode, Dt as toDisplayString, Et as normalizeStyle, K as withCtx, M as createVNode, O as createElementBlock, R as onBeforeUnmount, S as Fragment, T as createBaseVNode, Tt as normalizeClass, U as renderList, V as openBlock, W as resolveComponent, c as formatPrice, j as createTextVNode, m as quotationApi, ot as unref, t as adminApi, tt as ref, w as computed, z as onMounted } from "./api-Cd2rmWmR.js";
...
var AdminDashboard_default = /*#__PURE__*/ _plugin_vue_export_helper_default({
	...
	setup(__props) {
		...
		onMounted(() => {
			loadDashboard();
			pollTimer = window.setInterval(() => loadDashboard(true), 2e3);
		});
