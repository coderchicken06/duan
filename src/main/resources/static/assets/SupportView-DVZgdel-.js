import { A as createStaticVNode, D as createCommentVNode, Dt as toDisplayString, O as createElementBlock, T as createBaseVNode, Tt as normalizeClass, V as openBlock, g as supportApi, j as createTextVNode, q as withDirectives, tt as ref } from "./api-Cd2rmWmR.js";
...
var SupportView_default = /*#__PURE__*/ _plugin_vue_export_helper_default({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			...
			])], -1)), createBaseVNode("div", _hoisted_2, [createBaseVNode("section", _hoisted_3, [_cache[13] || (_cache[13] = createStaticVNode("<aside class=\"support-info\" data-v-c5cc242a><article class=\"support-info-item\" data-v-c5cc242a><span data-v-c5cc242a>01</span><div data-v-c5cc242a><h2 data-v-c5cc242a>Tư vấn mua xe</h2><p data-v-c5cc242a>Giải đáp thông tin sản phẩm và lựa chọn xe phù hợp.</p></div></article><article class=\"support-info-item\" data-v-c5cc242a><span data-v-c5cc242a>02</span><div data-v-c5cc242a><h2 data-v-c5cc242a>Bảo hành</h2><p data-v-c5cc242a>Tiếp nhận yêu cầu kiểm tra bảo hành hoặc phản hồi dịch vụ.</p></div></article><article class=\"support-info-item\" data-v-c5cc242a><span data-v-c5cc242a>03</span><div data-v-c5cc242a><h2 data-v-c5cc242a>Yêu cầu chung</h2><p data-v-c5cc242a>Gửi câu hỏi khác liên quan đến sản phẩm và tài khoản.</p></div></article><div class=\"support-contact\" data-v-c5cc242a><strong data-v-c5cc242a>Cần hỗ trợ?</strong><span data-v-c5cc242a>Hotline: 1900 9999</span><span data-v-c5cc242a>Email: support@carstore.vn</span></div></aside>", 1)), createBaseVNode("div", _hoisted_4, [_cache[12] || (_cache[12] = createBaseVNode("div", { class: "form-heading" }, [createBaseVNode("h2", null, "Gửi yêu cầu hỗ trợ"), createBaseVNode("p", null, [
