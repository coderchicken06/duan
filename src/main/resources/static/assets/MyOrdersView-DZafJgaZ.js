...
import { a as useRoute, d as vModelText, p as withModifiers, t as _plugin_vue_export_helper_default, u as vModelSelect } from "./index-LltwIOcO.js";
...
var _hoisted_15 = { class: "rating-label" };
var _hoisted_16 = {
	key: 1,
	class: "alert alert-danger mt-3 mb-0"
};
var _hoisted_17 = { class: "d-flex justify-content-end gap-2 mt-3" };
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("div", _hoisted_1, [
				...
				createBaseVNode("div", _hoisted_2, [createBaseVNode("table", _hoisted_3, [_cache[6] || (_cache[6] = createBaseVNode("thead", null, [createBaseVNode("tr", null, [
					...
					return openBlock(), createElementBlock("tr", { key: o.id }, [
						...
						createBaseVNode("td", null, [createVNode(_component_router_link, { to: `/order/detail/${o.id}` }, {
							...
							_: 1
						}, 8, ["to"]), isCompleted(o) && isOrderReviewed(o) ? (openBlock(), createElementBlock("span", _hoisted_7, "Đã đánh giá")) : isCompleted(o) ? (openBlock(), createElementBlock("button", {
							key: 1,
							class: "btn btn-danger btn-sm ms-2",
							type: "button",
							onClick: ($event) => openReview(o)
						}, " Đánh giá xe ", 8, _hoisted_8)) : createCommentVNode("", true)])
					]);
				}), 128))])]), orders.value.length === 0 ? (openBlock(), createElementBlock("p", _hoisted_9, "Chưa có đơn hàng nào.")) : createCommentVNode("", true)]),
				reviewOrder.value ? (openBlock(), createElementBlock("div", {
					...
					reviewCars.value.length > 1 ? (openBlock(), createElementBlock("div", _hoisted_11, [_cache[8] || (_cache[8] = createBaseVNode("label", {
						class: "form-label",
						for: "review-car"
						...
						return openBlock(), createElementBlock("option", {
							key: item.car?.id,
							value: item.car?.id
						}, toDisplayString(item.car?.name), 9, _hoisted_12);
					...
					createBaseVNode("div", _hoisted_13, [
						...
						createBaseVNode("div", {
							...
							}, [..._cache[9] || (_cache[9] = [createBaseVNode("path", { d: "M12 2.5l2.94 5.96 6.58.96-4.76 4.64 1.12 6.56L12 17.54l-5.88 3.08 1.12-6.56-4.76-4.64 6.58-.96L12 2.5z" }, null, -1)])], 2))], 40, _hoisted_14);
						}), 64))], 32),
						createBaseVNode("small", _hoisted_15, toDisplayString(satisfactionLabel.value), 1)
					]),
					...
					reviewError.value ? (openBlock(), createElementBlock("p", _hoisted_16, toDisplayString(reviewError.value), 1)) : createCommentVNode("", true),
					createBaseVNode("div", _hoisted_17, [createBaseVNode("button", {
					...
					}, toDisplayString(reviewSubmitting.value ? "Đang gửi..." : "Gửi đánh giá"), 9, _hoisted_18)])
				])])) : createCommentVNode("", true)
			]);
		};
	}
}, [["__scopeId", "data-v-0a2d9a0a"]]);
//#endregion
