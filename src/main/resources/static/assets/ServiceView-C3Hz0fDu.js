...
import { a as useRoute, f as withModifiers, i as useAuthStore, l as vModelSelect, n as _plugin_vue_export_helper_default, u as vModelText } from "./index-BCOVk736.js";
import { t as DatePickerInput_default } from "./DatePickerInput-CdBS-OUl.js";
...
var ServiceView_default = /*#__PURE__*/ _plugin_vue_export_helper_default({
	...
	setup(__props) {
		...
		function validateForm() {
			...
			if (form.value.appointmentTime < showroomOpenTime || form.value.appointmentTime > showroomCloseTime) return "Showroom chỉ tiếp nhận xe từ 07:30 đến 18:30.";
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("main", _hoisted_1, [_cache[15] || (_cache[15] = createBaseVNode("section", { class: "ford-hero-panel compact content-only service-hero" }, [createBaseVNode("div", { class: "ford-hero-panel-content" }, [
				...
				createBaseVNode("div", _hoisted_12, [
					...
					_cache[13] || (_cache[13] = createBaseVNode("small", null, "Showroom nhận lịch từ 07:30 đến 18:30.", -1))
				]),
