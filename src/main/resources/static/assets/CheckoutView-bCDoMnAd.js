import { D as createCommentVNode, Dt as toDisplayString, O as createElementBlock, T as createBaseVNode, V as openBlock, c as formatPrice, j as createTextVNode, o as cartApi, ot as unref, q as withDirectives, tt as ref, u as orderApi, z as onMounted } from "./api-Cd2rmWmR.js";
import { f as withModifiers, n as _plugin_vue_export_helper_default, o as useRouter, r as useCartStore, u as vModelText } from "./index-DOyj8jjE.js";
		...
		async function submit() {
			...
			try {
				...
				if (data.success) {
					...
					router.push({
						path: `/orders/${data.orderId}/payment`,
						query: { method: "sepay" }
					});
